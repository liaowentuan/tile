window.BMAP_AUTHENTIC_KEY = ""; (function() {
    ...
    z.ma = "http://10.10.96.209/tiles/"; // 图片路径 路径 http://10.10.96.209/tiles/images || js 
            ...
            if (d.Bd == this.Fj.Zp) c && b();
                ...
                if (d.Bd == this.Fj.hG) {
                    ...
                    e.zC == q && (e.zC = o, setTimeout(function() {
                        ...
                        if (a.length > 0) {
                            console.log(a);
                            Pb("http://10.10.96.209/tiles/js/getmodules.js"); // getmodules.js 路径
                        } else {
                            e.LK()
                        }
                    },
    ...
    Uc.getTilesUrl = function(a, b, c) {
        ...
        e = 1,
        z = b;
        return "http://10.10.96.209:8080/tile/tiles/" + z + "/" + x + "/" + y + ".png"; // 瓦图路径
    };
    var La = new Qc("\u5730\u56fe", Uc, {
        tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
        maxZoom: 19
